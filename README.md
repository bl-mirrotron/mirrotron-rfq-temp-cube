...
The schematic for the electrical cirucit is shown in Figure 1. The board is designed to handle up to eight probes. The PCB layout for the electrical cirucit is shown in Figure 2. A manufactured board is shown in Figure 3.
